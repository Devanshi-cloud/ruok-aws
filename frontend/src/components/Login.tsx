                        ...
                        <Card className={'p-0'}>
                            <MagicCard className={'w-full h-full py-8'} gradientColor={theme === "dark" ? "#252525" : "#D9D9D955"}>
                                <CardHeader className={'flex flex-col items-center justify-center mb-12'}>
                                    ...
                                    <CardDescription>
                                        {userType === 'student' 
                                            ...
                                            : 'Enter your email and password to login as therapist'}
                                    </CardDescription>
                                </CardHeader>
                                ...
                                <CardFooter className={'my-4 flex flex-col items-center justify-center'}>
                                    ...
                                    <div onClick={() => dispatch(setUserType(userType === 'student' ? 'therapist' : 'student'))}>
                                        <CardDescription className={'font-medium mt-4 cursor-pointer hover:underline'}>
